...
{
    [CustomEditor(typeof(SmoothHorizontalOrVerticalLayoutGroup), true)]
    ...
    /// </summary>
    public class SmoothHorizontalOrVerticalLayoutGroupEditor : Editor
    {

        SerializedProperty m_MoveDuration;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_MoveDuration, true);
